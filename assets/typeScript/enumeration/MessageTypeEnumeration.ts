...
export const MessageTypeEnumeration = { 
  ...
  USER_START_TO_PLAY_CARD : new MessageType("USER_START_TO_PLAY_CARD", "userStartToPlayCard", "用户开始出牌"),
  USER_DO_PLAY_CARD : new MessageType("USER_DO_PLAY_CARD", "useDoPlayCard", "用户出牌"),
  USER_DO_NOT_PLAY_CARD : new MessageType("USER_DO_NOT_PLAY_CARD", "userDoNotPlayCard", "用户不出牌"),

  USER_WIN : new MessageType("USER_WIN", "userWin", "用户赢得一局"),
}
